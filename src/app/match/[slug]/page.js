    ...
    return (
        <main className="my-4 px-4 xl:px-8">
            <div className="container max-w-screen-xl mx-auto">
                ...
                <div className="flex flex-col  gap-2 md:flex-row justify-between items-center w-full bg-blue-gray-50 bg-opacity-60 py-2 px-4 rounded-md mb-5">
                    <Typography variant="h5" color="blue-gray" 
                    className="text-md md:text-xl flex justify-end items-center gap-2 w-full md:w-11/12">
                    ...
                    <Typography variant="h5" color="blue-gray" className="text-md md:text-xl flex items-center gap-2 w-full md:w-11/12">
                ...
                {embedUrl && (
                    <div className="mb-4">
                        <div dangerouslySetInnerHTML={{ __html: `<iframe src="${embedUrl ? embedUrl : ""}" allow="picture-in-picture; fullscreen" allowfullscreen class="w-full h-60 sm:h-96 md:h-[600px]"></iframe>` }} />
                    </div>
                )}
                {!embedUrl && (
                    <div className="mb-4">
